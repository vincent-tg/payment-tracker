...
async fn main() -> anyhow::Result<()> {
    ...
    let connection_string = "postgres://payment_user:payment_password@10.0.0.229:30432/payment_tracker";
    ...
    println!("  With conversion: {}", test_transaction.format_with_conversion());
